...
You can access the lecture notes at the following links.
  ...
  - [Week 12 · Dendrograms](./notes/compmus2023-w12.html)
...
One visualization that might be visually useful, but might be hard to figure out how to do is colouring a dendrogram based on the original labels from the dataset.
There are sevearl libraries that do this in R, but not many that work well with the code we have provided for you. 
...
Note that in order to do this type of analysis you are not allowed to have more than song exist in more two classes at once!
In order to get around this, we have included code to remove all duplicates.
